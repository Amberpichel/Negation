...
def calculate_entropy(file_name_1, file_name_2, file_name_3):
    ...
    ''' 
    calculates entropy for conll files
...
def get_topx_entropy(path1, path2, path3, topx=3):
    '''
    calculates the entropy for the conll files in the selected paths 
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Script for entropy calculation and output (conll files).')
